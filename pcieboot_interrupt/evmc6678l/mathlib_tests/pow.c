...
void POW_spTest(char * psFuncName, uint32_t ui32Size, float * pfBuffer)
{
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = powsp(pfBuffer[ui32Idx],pfBuffer[ui32IdxCount-1-ui32Idx]);
		}
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = powsp_i(pfBuffer[ui32Idx],pfBuffer[ui32IdxCount-1-ui32Idx]);
		}
...
void POW_dpTest(char * psFuncName, uint32_t ui32Size, float * pfBuffer)
{
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = powdp(pfBuffer[ui32Idx],pfBuffer[ui32IdxCount-1-ui32Idx]);
		}
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = powdp_i(pfBuffer[ui32Idx],pfBuffer[ui32IdxCount-1-ui32Idx]);
		}
