...
// ATAN
//
void ATAN_runTests(char * psFuncName, uint32_t ui32Size, float * pfBuffer);
...
// COS
//
void COS_runTests(char * psFuncName, uint32_t ui32Size, float * pfBuffer);
...
// EXP2
//
void EXP2_runTests(char * psFuncName, uint32_t ui32Size, float * pfBuffer);
