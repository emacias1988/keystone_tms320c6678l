...
void DIV_runTests(char * psFuncName, uint32_t ui32Size, float * pfSrcBuffer, float * pfDestBuffer)
{
	...
	DIV_spTest(psFuncName,ui32Size,pfSrcBuffer);

	DIV_dpTest(psFuncName,ui32Size,pfSrcBuffer);
}
...
void DIV_spTest(char * psFuncName, uint32_t ui32Size, float * pfBuffer)
{
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			g_pfDestBuffer[ui32Idx] = pfBuffer[ui32Idx]/(float)2.3456789;
		}
...
void DIV_dpTest(char * psFuncName, uint32_t ui32Size, float * pfBuffer)
{
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			g_pdDestBuffer[ui32Idx] = pfBuffer[ui32Idx]/(double)2.5432245786542;
		}
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			g_pdDestBuffer[ui32Idx] = pfBuffer[ui32Idx]/(double)2.543223242786542;
		}
