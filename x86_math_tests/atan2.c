...
void ATAN2_runTests(char * psFuncName, uint32_t ui32Size, float * pfSrcBuffer, float * pfDestBuffer)
{
	...
	ATAN2_spTest(psFuncName,ui32Size,pfSrcBuffer);

	ATAN2_dpTest(psFuncName,ui32Size,pfSrcBuffer);
}
...
void ATAN2_spTest(char * psFuncName, uint32_t ui32Size, float * pfBuffer)
{
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			g_pfDestBuffer[ui32Idx] = atan2f(pfBuffer[ui32Idx],(float)2.3456789);
		}
...
void ATAN2_dpTest(char * psFuncName, uint32_t ui32Size, float * pfBuffer)
{
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			g_pdDestBuffer[ui32Idx] = atan2(pfBuffer[ui32Idx],(double)2.3456789);
		}
	...
	while(ui32TotalSize)
	{
		...
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			g_pdDestBuffer[ui32Idx] = atan2(pfBuffer[ui32Idx],(double)2.345632324789);
		}
