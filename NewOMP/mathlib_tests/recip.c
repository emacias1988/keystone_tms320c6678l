...
//			printf ("Core: %d Result[%d] of recipsp is %f\n",coreid,ui32Idx,(float)pfBuffer[ui32Idx]);
...
//	{
//
//		printf ("Result[%d] of recipsp is %f\n",ui32Idx,(float)pfBuffer[ui32Idx]);
//
//	}
...
#pragma omp for
		...
		//	printf ("Result of recipsp_i is %f\n",pfBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = recipdp(pdBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = recipdp_i(pdBuffer[ui32Idx]);
