...
{
	ATAN_spTest(psFuncName,ui32Size,pfBuffer);

	ATAN_dpTest(psFuncName,ui32Size,pfBuffer);
}
...
//	{
//
//		printf ("Result[%d] of atansp is %f\n",ui32Idx,(float)pfBuffer[ui32Idx]);
//
//	}
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = atansp_i(pfBuffer[ui32Idx]);
		//	printf ("Result of atansp_i is %f\n",pfBuffer[ui32Idx]);
