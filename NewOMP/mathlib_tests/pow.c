...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = powsp(pfBuffer[ui32Idx],(float)2.3456789);
//			coreid = omp_get_thread_num(); 		  // Get master core
//			printf ("Core: %d Result[%d] of powsp is %f\n",coreid,ui32Idx,(float)pfBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = powsp_i(pfBuffer[ui32Idx],(float)2.3445679);
		//	printf ("Result of powsp_i is %f\n",pfBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = powdp(pdBuffer[ui32Idx],(double)2.344356789);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = powdp(pdBuffer[ui32Idx],(double)2.543245786542);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = powdp_i(pdBuffer[ui32Idx],(double)2.35644356789);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = powdp_i(pdBuffer[ui32Idx],(double)2.344356789);
