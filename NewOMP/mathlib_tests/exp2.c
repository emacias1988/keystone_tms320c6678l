...
//	{
//
//		printf ("Result[%d] of exp2sp is %f\n",ui32Idx,(float)pfBuffer[ui32Idx]);
//
//	}
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = exp2sp_i(pfBuffer[ui32Idx]);
		//	printf ("Result of exp2sp_i is %f\n",pfBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = exp2dp(pdBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = exp2dp_i(pdBuffer[ui32Idx]);
