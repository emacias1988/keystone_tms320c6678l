...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = sinsp_i(pfBuffer[ui32Idx]);
		//	printf ("Result of sinsp_i is %f\n",pfBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = sindp(pdBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = sindp_i(pdBuffer[ui32Idx]);
