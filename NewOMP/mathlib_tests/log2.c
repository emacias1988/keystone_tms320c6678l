...
void LOG2_runTests(char * psFuncName, uint32_t ui32Size, float * pfBuffer)
{
	LOG2_spTest(psFuncName,ui32Size,pfBuffer);

//	LOG2_dpTest(psFuncName,ui32Size,pfBuffer);
}
...
//	{
//
//		printf ("Result[%d] of log2sp is %f\n",ui32Idx,(float)pfBuffer[ui32Idx]);
//
//	}
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = log2sp_i(pfBuffer[ui32Idx]);
		//	printf ("Result of log2sp_i is %f\n",pfBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = log2dp(pdBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = log2dp_i(pdBuffer[ui32Idx]);
