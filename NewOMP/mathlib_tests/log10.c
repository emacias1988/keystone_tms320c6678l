...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = log10sp(pfBuffer[ui32Idx]);
//			coreid = omp_get_thread_num(); 		  // Get master core
//			printf ("Core: %d Result[%d] of log10sp is %f\n",coreid,ui32Idx,(float)pfBuffer[ui32Idx]);
...
//	{
//
//		printf ("Result[%d] of log10sp is %f\n",ui32Idx,(float)pfBuffer[ui32Idx]);
//
//	}
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pfBuffer[ui32Idx] = log10sp_i(pfBuffer[ui32Idx]);
		//	printf ("Result of log10sp_i is %f\n",pfBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = log10dp(pdBuffer[ui32Idx]);
...
#pragma omp for
		for(ui32Idx=0;ui32Idx<ui32IdxCount;ui32Idx++)
		{
			pdBuffer[ui32Idx] = log10dp_i(pdBuffer[ui32Idx]);
